...
def solve_qubo(Q, use_hybrid_solver, num_reads=1000):
...
selected_features = ['Tmelt', 'Smix', 'Hmix', 'Omega', 'Phi2', 'Eta', 'E2_E0', 'PFP_A1', 'PFP_A2', 'PFP_A3', 'PFP_Laves', 'PFP_Sigma', 'Electronegativity', 'Ionic_E_2nd', 'Ionic_E_3rd', 'Bulk', 'Poisson']  
